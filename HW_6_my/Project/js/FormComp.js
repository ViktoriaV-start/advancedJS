        ...
        <div class='searchResult__wrap container invsbl'>
            <h3 class="searchResult__text">Результат поиска</h3>
                <div class="searchResult">
                    <div class="product__item" v-for="el of $parent.abc" :key="el.id_product" data-id="el.id_product">
                        ...
                        <div class="desc">
                            ...
                            <button class="products__buyBtn" @click="$parent.$emit('add-product', el)">Купить</button>
                        </div>                        
                    </div>    
                </div>
            </div>
